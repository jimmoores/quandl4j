...
public final class Row {
  ...
  private Row(final HeaderDefinition headerDefinition, final String[] values) {
    if (headerDefinition.size() != values.length) {
      s_logger.error("Attempt to create a Row with a header definition containing {} columns and a values array containing {} values",
          headerDefinition.size(), values.length);
  ...
  /**
   * Returns an entry from a given column index as a LocalDate (possibly null). Throws an ArrayIndexOutOfBoundsException if the index is
  ...
  /**
   * Returns an entry from a given column index as a Double (possibly null). Throws as ArrayIndexOutOfBoundsException if the index is
  ...
  /**
   * Returns an entry from a given column name as a Double (possibly null). Throws an IllegalArgumentException if the name is not defined in
