...
Quandl4J uses [Travis CI](http://travis-ci.org/jimmoores/quandl4j) to perform continuous builds.  The current status of the build is ![Master Branch Build Status](https://travis-ci.org/jimmoores/quandl4j.svg?branch=master)
