 ...
 * <li>{link RESTDataProvider} - interface for fetching documents. Default implementation does Jersey HTTP Client REST call. Other
 * implementations are used for testing (saving responses in files and replaying responses.</li>
