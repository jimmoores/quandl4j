...
/**
 * A runtime exception from the Quandl client indicating an HTTP 429 response code (Too many requests). This generally indicates that you've
 * made more than your allowance of requests in that day. A common solution is to use a proper API auth token (available via your account
 * login on Quandl) to pass in when creating the QuandlSession.
 */
