/**
 * <h1>Quandl wrapper classic API test classes.</h1>
 ...
 * </ul>
 * <p>The URL generation and regression tests work by injecting special {@code ClassicRESTDataProvider}
 ...
 * connection.</p>
 * <p>These ClassicRESTDataProviders can be reused by your own application specific tests.  They are passed into
